...
class Reviews {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Reviews_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'REVIEWS_VERSION' ) ) {
			$this->version = REVIEWS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Reviews_Loader. Orchestrates the hooks of the plugin.
	 * - Reviews_i18n. Defines internationalization functionality.
	 * - Reviews_Admin. Defines all hooks for the admin area.
	 * - Reviews_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Reviews_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		// Shortcodes
		$this->loader->add_action( 'init', $plugin_public, 'aucor_register_shortcodes' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Reviews_Loader    Orchestrates the hooks of the plugin.
	 */
